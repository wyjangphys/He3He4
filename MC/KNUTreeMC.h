...
Int_t KNUTreeMC::Fragmented(Long64_t entry)
{/*{{{*/
  for( Int_t i = 0; i < 9; i++ )
...
Double_t KNUTreeMC::GetCorrectedTrackerCharge( Double_t beta, Double_t z )
{/*{{{*/
...
Double_t KNUTreeMC::GetMeanEdep(Int_t nSample, Float_t* pEdepArray)
{/*{{{*/
...
void KNUTreeMC::Write(TString outputFileName)
{/*{{{*/
  /// Save data
